  ...
  Future<void> registerUser() async {
    ...
    if (!GetUtils.isEmail(email.value.trim())) {
      _showCustomSnackbar(
        ...
        message:
            'Silakan masukkan alamat email yang valid (contoh: nama@gmail.com).',
        isError: true,
      );
      return;
    }
    ...
    if (password.value.length < 6) {
      _showCustomSnackbar(
        ...
        message:
            'Demi keamanan, gunakan password minimal 6 karakter atau lebih.',
        isError: true,
      );
      return;
    }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _showSuccessDialog(
          data['message'] ?? "Cek email Anda untuk verifikasi",
        );
      } else {
      ...
      _showCustomSnackbar(
        ...
        message:
            'Gagal terhubung ke server. Pastikan perangkat Anda tersambung ke internet.',
        isError: true,
      );
    }
  }
