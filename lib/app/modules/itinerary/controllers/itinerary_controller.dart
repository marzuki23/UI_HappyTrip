...
class ItineraryController extends GetxController {
  ...
  final RecommendationController recommendationCtrl =
  ...
  final List<Map<String, dynamic>> allDestinations = [
    {
      "title": "Bukit Sikunir",
      "desc":
          "Destinasi wisata populer di Dataran Tinggi Dieng, Jawa Tengah, terkenal dengan pemandangan golden sunrise terbaik di Asia Tenggara.",
    ...
    },
    {
      ...
      "desc":
          "Gunung api aktif bertipe stratovolcano tertinggi kedua di Jawa Tengah (setelah Gunung Slamet) dengan ketinggian 3.371 mdpl.",
    ...
    },
    {
      ...
      "desc":
          "Gunung stratovolcano aktif yang terletak di Jawa Tengah, berbatasan dengan Kabupaten Temanggung dan Wonosobo.",
  ...
  double get attractionCost =>
      selectedDestinations.fold(0, (sum, item) => sum + item['price']);
